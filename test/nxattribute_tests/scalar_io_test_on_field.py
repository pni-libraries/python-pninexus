...
class scalar_io_test_on_field_uint8(unittest.TestCase):
    """
    ...
    @classmethod
    def setUpClass(self):
        self.file_name = "scalar_io_test_on_field_{tc}.nxs".format(tc=self._typecode)
    ...
    def test_scalar_to_scalar_write_read_method(self):
        ...
        a = self.field.attributes.create("scalar_read_write",self._typecode)
    ...
    def test_scalar_array_to_scalar_write_read_method(self):
        ...
        a = self.field.attributes.create("scalar_array_read_write",
                                         self._typecode)
    ...
    def test_scalar_to_scalar_setitem_getitem(self):
        ...
        a = self.field.attributes.create("scalar_setitem_getitem",
                                        self._typecode)
    ...
    def test_scalar_array_to_scalar_setitem_getitem(self):
        ...
        a = self.field.attributes.create("scalar_array_setitem_getitem",
                                        self._typecode)
    ...
    def test_scalar_to_1Dfield_partial_individual(self):
        ...
        a = self.field.attributes.create("scalar_to_1D_partial_individual",
                                   self._typecode,
                                   shape=(10,))
    ...
    def test_scalar_array_to_1Dfield_partial_individual(self):
        ...
        a = self.field.attributes.create("scalar_array_to_1D_partial_individual",
                                   self._typecode,
                                   shape=(10,))
    ...
    def test_scalar_to_1Dfield_broadcast(self):
        ...
        a = self.field.attributes.create("scalar_to_1D_broadcast",
    ...
    def test_scalar_array_to_1Dfield_broadcast(self):
        ...
        a = self.field.attributes.create("scalar_array_to_1D_broadcast",
                                   self._typecode,shape=(10,))
    ...
    def test_scalar_to_2Dfield_partial_individual(self):
        ...
        a = self.field.attributes.create("scalar_to_2d_indivdual",
                                   self._typecode,
                                   shape=(3,4))
    ...
    def test_scalar_from_2Dfield_partial_strips(self):
        ...
        a = self.field.attributes.create("scalar_to_2d_strips",
                                   self._typecode,
                                   shape=(3,4))
    ...
    def test_scalar_from_2Dfield_broadcast(self):
        ...
        a = self.field.attributes.create("scalar_to_2d_broadcast",
                                   self._typecode,
                                   shape=(3,4))
        a[...] = self.input_data
...
#=============================================================================
class scalar_io_test_on_field_uint16(scalar_io_test_on_field_uint8):
    _typecode = "uint16"

#=============================================================================
class scalar_io_test_on_field_uint32(scalar_io_test_on_field_uint8):
    _typecode = "uint32"

#=============================================================================
class scalar_io_test_on_field_uint64(scalar_io_test_on_field_uint8):
    _typecode = "uint64"

#=============================================================================
class scalar_io_test_on_field_int8(scalar_io_test_on_field_uint8):
    _typecode = "int8"

#=============================================================================
class scalar_io_test_on_field_int16(scalar_io_test_on_field_uint8):
    _typecode = "int16"

#=============================================================================
class scalar_io_test_on_field_int32(scalar_io_test_on_field_uint8):
    _typecode = "int32"

#=============================================================================
class scalar_io_test_on_field_int64(scalar_io_test_on_field_uint8):
    _typecode = "int64"

#=============================================================================
class scalar_io_test_on_field_float32(scalar_io_test_on_field_uint8):
    _typecode = "float32"

#=============================================================================
class scalar_io_test_on_field_float64(scalar_io_test_on_field_uint8):
    _typecode = "float64"

#=============================================================================
class scalar_io_test_on_field_float128(scalar_io_test_on_field_uint8):
    _typecode = "float128"

#=============================================================================
class scalar_io_test_on_field_complex32(scalar_io_test_on_field_uint8):
    _typecode = "complex32"

#=============================================================================
class scalar_io_test_on_field_complex64(scalar_io_test_on_field_uint8):
    _typecode = "complex64"

#=============================================================================
class scalar_io_test_on_field_complex128(scalar_io_test_on_field_uint8):
    _typecode = "complex128"

#=============================================================================
class scalar_io_test_on_field_bool(scalar_io_test_on_field_uint8):
    _typecode = "bool"

#=============================================================================
class scalar_io_test_on_field_string(scalar_io_test_on_field_uint8):
    _typecode = "string"
...
if sys.version_info[0]<=2:
    class scalar_io_test_on_field_unicode(scalar_io_test_on_field_string):
        _type_code="string"
