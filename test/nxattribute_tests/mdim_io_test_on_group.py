...
class mdim_io_test_on_group_uint8(unittest.TestCase):
    """
    Testing multidimensional IO on an attribute attached to a group.
    """
    _typecode = "uint8"
    ...
    @classmethod
    def setUpClass(self):
        self.file_name = "mdim_io_test_on_group_{tc}.nxs".format(tc=self._typecode)
    ...
    def test_mdim_to_mdim_setitem_getitem(self):
        ...
        a = self.root.attributes.create("mdim_setitem_getitem",self._typecode,
                                        shape=self.shape)
...
#=============================================================================
class mdim_io_test_on_group_uint16(mdim_io_test_on_group_uint8):
    _typecode = "uint16"

#=============================================================================
class mdim_io_test_on_group_uint32(mdim_io_test_on_group_uint8):
    _typecode = "uint32"

#=============================================================================
class mdim_io_test_on_group_uint64(mdim_io_test_on_group_uint8):
    _typecode = "uint64"

#=============================================================================
class mdim_io_test_on_group_int8(mdim_io_test_on_group_uint8):
    _typecode = "int8"

#=============================================================================
class mdim_io_test_on_group_int16(mdim_io_test_on_group_uint8):
    _typecode = "int16"

#=============================================================================
class mdim_io_test_on_group_int32(mdim_io_test_on_group_uint8):
    _typecode = "int32"

#=============================================================================
class mdim_io_test_on_group_int64(mdim_io_test_on_group_uint8):
    _typecode = "int64"

#=============================================================================
class mdim_io_test_on_group_float32(mdim_io_test_on_group_uint8):
    _typecode = "float32"

#=============================================================================
class mdim_io_test_on_group_float64(mdim_io_test_on_group_uint8):
    _typecode = "float64"

#=============================================================================
class mdim_io_test_on_group_float128(mdim_io_test_on_group_uint8):
    _typecode = "float128"

#=============================================================================
class mdim_io_test_on_group_complex32(mdim_io_test_on_group_uint8):
    _typecode = "complex32"

#=============================================================================
class mdim_io_test_on_group_complex64(mdim_io_test_on_group_uint8):
    _typecode = "complex64"

#=============================================================================
class mdim_io_test_on_group_complex128(mdim_io_test_on_group_uint8):
    _typecode = "complex128"

#=============================================================================
class mdim_io_test_on_group_bool(mdim_io_test_on_group_uint8):
    _typecode = "bool"

#=============================================================================
class mdim_io_test_on_group_string(mdim_io_test_on_group_uint8):
    _typecode = "string"

#=============================================================================
if sys.version_info[0]<=2:
    class mdim_io_test_on_group_unicode(mdim_io_test_on_group_string):
        _type_code="string"
