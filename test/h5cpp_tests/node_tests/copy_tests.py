...
class FunctionTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.dataset = node.Dataset(self.root,h5cpp.Path("sensors/temperature"),
...
class MoveTests(FunctionTests):
    ...
    def testMoveToPath(self):
        ...
        self.assertFalse(self.root.nodes["sensors"].nodes.exists("temperature"))
...
class RemoveTests(FunctionTests):
    ...
    def testRemoveByPath(self):
        ...
        h5cpp.node.remove(base=self.root,path=h5cpp.Path("sensors/temperature"))
        self.assertFalse(self.root.nodes['sensors'].nodes.exists("temperature"))
