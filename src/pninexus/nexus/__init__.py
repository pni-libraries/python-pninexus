...
def base_class_factory_create(parent, name, base_class,
    ...
    :param h5cpp.property.LinkCreationList lcpl: optional reference to a link creation property list
    :param h5cpp.property.GroupCreationList gcpl: optional reference to a group creation property list
    :param h5cpp.property.GroupAccessList gapl: optional reference to a group access property list
...
def field_factory_create(parent, name, dtype, shape=None, max_shape=None,
    ...
    :param h5cpp.property.LinkCreationList lcpl: optional reference to a link creation property list
    :param h5cpp.property.DatasetCreationList dcpl: optional reference to a dataset creation property list
    :param h5cpp.property.DatasetAccessList dapl: optional reference to a dataset access property list
    ...
    #
    dataset = FieldFactory.create_(parent,h5cpp.Path(name),datatype,dataspace,lcpl,dcpl,dapl)
    ...
    if units!=None:
        ...
        unit_attr = dataset.attributes.create("units",h5cpp.datatype.kVariableString)
